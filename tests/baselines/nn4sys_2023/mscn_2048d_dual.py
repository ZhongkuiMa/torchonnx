...
Source: /mnt/hdd1/zhongkui/rover_project/rover_alpha/torchonnx/tests/vnncomp2024_benchmarks/nn4sys_2023/onnx/mscn_2048d_dual.onnx
Generated: 2025-12-22 03:36:21

This module was automatically converted from an ONNX model.
"""

__all__ = ["Nn4sys2023Mscn2048dDual"]

import torch
import torch.nn as nn


class Nn4sys2023Mscn2048dDual(nn.Module):
    def __init__(self):
        super().__init__()
        self.register_buffer("c35", torch.empty([6, 2048], dtype=torch.float32))
        self.register_buffer("c36", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c37", torch.empty([2048, 2048], dtype=torch.float32))
        self.register_buffer("c38", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c39", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c40", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c41", torch.empty([13, 2048], dtype=torch.float32))
        self.register_buffer("c42", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c43", torch.empty([2048, 2048], dtype=torch.float32))
        self.register_buffer("c44", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c45", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c46", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c47", torch.empty([6, 2048], dtype=torch.float32))
        self.register_buffer("c48", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c49", torch.empty([2048, 2048], dtype=torch.float32))
        self.register_buffer("c50", torch.empty([2048], dtype=torch.float32))
        self.register_buffer("c51", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c52", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c80", torch.empty([6, 2048], dtype=torch.float32))
        self.register_buffer("c81", torch.empty([2048, 2048], dtype=torch.float32))
        self.register_buffer("c82", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c83", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c84", torch.empty([13, 2048], dtype=torch.float32))
        self.register_buffer("c85", torch.empty([2048, 2048], dtype=torch.float32))
        self.register_buffer("c86", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c87", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c88", torch.empty([6, 2048], dtype=torch.float32))
        self.register_buffer("c89", torch.empty([2048, 2048], dtype=torch.float32))
        ...
        self.relu12 = nn.ReLU()
        self.relu13 = nn.ReLU()
        self.linear3 = nn.Linear(6144, 2048)
        self.relu14 = nn.ReLU()

...
Source: /mnt/hdd1/zhongkui/rover_project/rover_alpha/torchonnx/tests/vnncomp2024_benchmarks/metaroom_2023/onnx/6cnn_tz_9_1_no_custom_OP.onnx
...
class Metaroom20236cnnTz91NoCustomOp(nn.Module):
    def __init__(self):
        super().__init__()

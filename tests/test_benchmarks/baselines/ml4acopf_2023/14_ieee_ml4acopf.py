...
Source: /mnt/hdd1/zhongkui/rover_project/rover_alpha/torchonnx/tests/vnncomp2024_benchmarks/ml4acopf_2023/onnx/14_ieee_ml4acopf.onnx
...
class Ml4acopf202314IeeeMl4acopf(nn.Module):
    def __init__(self):
        super().__init__()

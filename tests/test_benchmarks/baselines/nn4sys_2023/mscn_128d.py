...
Source: /mnt/hdd1/zhongkui/rover_project/rover_alpha/torchonnx/tests/vnncomp2024_benchmarks/nn4sys_2023/onnx/mscn_128d.onnx
Generated: 2025-12-22 03:36:18

This module was automatically converted from an ONNX model.
"""

__all__ = ["Nn4sys2023Mscn128d"]

import torch
import torch.nn as nn


class Nn4sys2023Mscn128d(nn.Module):
    def __init__(self):
        super().__init__()
        self.register_buffer("c27", torch.empty([6, 128], dtype=torch.float32))
        self.register_buffer("c28", torch.empty([128], dtype=torch.float32))
        self.register_buffer("c29", torch.empty([128, 128], dtype=torch.float32))
        self.register_buffer("c30", torch.empty([128], dtype=torch.float32))
        self.register_buffer("c31", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c32", torch.empty([1], dtype=torch.int64))
        self.register_buffer("c33", torch.empty([13, 128], dtype=torch.float32))
        self.register_buffer("c34", torch.empty([128], dtype=torch.float32))
        self.register_buffer("c35", torch.empty([128, 128], dtype=torch.float32))
        ...
        self.register_buffer("c39", torch.empty([6, 128], dtype=torch.float32))
        self.register_buffer("c40", torch.empty([128], dtype=torch.float32))
        self.register_buffer("c41", torch.empty([128, 128], dtype=torch.float32))

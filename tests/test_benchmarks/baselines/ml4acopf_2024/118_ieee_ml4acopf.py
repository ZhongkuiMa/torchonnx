...
Source: /mnt/hdd1/zhongkui/rover_project/rover_alpha/torchonnx/tests/vnncomp2024_benchmarks/ml4acopf_2024/onnx/118_ieee_ml4acopf.onnx
Generated: 2025-12-22 03:36:18

This module was automatically converted from an ONNX model.
"""

__all__ = ["Ml4acopf2024118IeeeMl4acopf"]
...
class Ml4acopf2024118IeeeMl4acopf(nn.Module):
    def __init__(self):
        super().__init__()
        self.register_buffer("c4", torch.empty([226], dtype=torch.float32))
        self.register_buffer("c5", torch.empty([226], dtype=torch.float32))
        self.register_buffer("c34", torch.empty([186], dtype=torch.int64))
        self.register_buffer("c35", torch.empty([186], dtype=torch.int64))
        self.register_buffer("c38", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c39", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c40", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c41", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c42", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c43", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c44", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c45", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c46", torch.empty([186], dtype=torch.float32))
        self.register_buffer("c47", torch.empty([186], dtype=torch.float32))
        ...
        self.register_buffer("c59", torch.empty([118, 99], dtype=torch.float32))
        self.register_buffer("c60", torch.empty([118, 54], dtype=torch.float32))
        self.register_buffer("c61", torch.empty([118, 186], dtype=torch.float32))
